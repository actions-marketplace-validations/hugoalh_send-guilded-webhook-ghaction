...
ENV APP_ROOT=/opt/hugoalh/send-guilded-webhook-ghaction
...
CMD deno run --allow-env --allow-net=media.guilded.gg --allow-read --allow-write --config=$APP_ROOT/deno.jsonc --lock --vendor $APP_ROOT/mod.ts
